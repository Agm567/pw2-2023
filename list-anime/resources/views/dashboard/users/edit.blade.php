                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{ url('/dashboard/users', $users->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group row">
                                        <label for="name" class="col-4 col-form-label">Name</label>
                                        <div class="col-8">
                                            <input id="name" name="name" value="{{ $users->name }}" type="text"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="email" name="email" value="{{ $users->email }}" type="text"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="password" name="password" placeholder="Leave blank if no change"
