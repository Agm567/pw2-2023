                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form method="post" action="{{ url('/dashboard/movies') }}">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="poster" name="poster" value="{{ old('poster') }}" type="text"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <select id="genres_id" name="genres_id" class="form-control">
                                                ...
                                                @foreach ($genres as $genre)
                                                    <option value="{{ $genre->id }}"
                                                        {{ $genre->id == old('genres_id') ? 'selected' : '' }}>
                                                        {{ $genre->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select id="countries_id" name="countries_id" class="form-control">
                                                ...
                                                @foreach ($countries as $countrie)
                                                    <option value="{{ $countrie->id }}"
                                                        {{ $countrie->id == old('countries_id') ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="release_date" name="release_date" value="{{ old('release_date') }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <input id="rating" name="rating" value="{{ old('rating') }}" type="text"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-8">
                                            <textarea id="synopsis" name="synopsis" value="{{ old('synopsis') }}" class="form-control">{{ old('synopsis') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
