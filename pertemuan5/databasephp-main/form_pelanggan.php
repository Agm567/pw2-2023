    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="jk" name="harga_beli" value="L" type="radio" class="form-control">Laki-Laki
                <input id="jk" name="harga_beli" value="P" type="radio" class="form-control">Perempuan
            </div>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="email" name="email" value="" type="date" class="form-control">
            </div>
        </div>
    </div>
    <div class="form-group row">
